const Footer = () => {
  return (
    <footer>
      <div className="flex justify-around justify-items-center py-8 text-white font-blender_pro_book font-normal leading-[120%]">
        <div className=" p-4 w-1/3 flex flex-col justify-start items-center">
